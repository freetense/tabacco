                ...
                <div id="fb-root"></div>
        <script type="text/javascript" src="{{ URL::asset('js/jquery/jquery.slides.js') }}"></script>
        <script type="text/javascript" src="{{ URL::asset('js/shoppica.products_slide.js') }}"></script>
